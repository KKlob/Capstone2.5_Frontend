...
function MemberCard({ member, handleClick, colSize }) {
    ...
    return (
        <Col xs={colSize} style={{ marginTop: '10px' }}>
            <Card style={{ height: '240px', width: 'auto', cursor: 'pointer', paddingTop: '10px', paddingBot: '10px', backgroundColor: partyColor }} className="memberCard text-center" onClick={handleClick}>
                ...
                <Card.Title style={{ fontSize: '20px', marginTop: '5px' }}>{`${member.first_name} ${member.last_name}`}</Card.Title>
